function result = logiseq(x1, x2, x3, design, theta, k)
    digits = 1500;
    ...
    result = mean(exp([1 x1 x2 x3 x1*x2 x1*x3 x2*x3] * theta) ./ ...
               (1 + exp([1 x1 x2 x3 x1*x2 x1*x3 x2*x3] * theta)).^2 .* Info_inv) - 7;
end
